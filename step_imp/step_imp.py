...
from gautomator.runner.helpers.driver_handler import DriverHandler
from gautomator.runner.helpers.setup import CommonUsage
from gautomator.factory.driver_factory import AppHelper
...
def suite_set_up():
    ...
    if not (is_api or is_web or is_mobile):
        ...
        if is_api:  # api case
            _swagger_url = os.getenv(EnvConst.S.SWAGGER_URL) % {'env': env}
            if _swagger_url:
